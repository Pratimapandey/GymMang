...
namespace GymMang.Migrations
{
    ...
    [Migration("20240123105341_ininin")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymMang.Models.GymTrainee", b =>
                {
            ...
            modelBuilder.Entity("GymMang.Models.GymTraineeDetailViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("gymTraineeTraineeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("gymTraineeTraineeId");

                    b.ToTable("GymTraineeDetailViewModel");
                });

            modelBuilder.Entity("GymMang.Models.MonthlyFeeVoucher", b =>
                {
                    b.Property<int>("MonthlyFeeVoucherID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymMang.Models.TrainingLevel", b =>
                {
                    b.Property<int>("TrainingLevelID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GymMang.Models.GymTrainee", b =>
                {
                    b.HasOne("GymMang.Models.TrainingLevel", "TrainingLevel")
            ...
            modelBuilder.Entity("GymMang.Models.GymTraineeDetailViewModel", b =>
                {
                    b.HasOne("GymMang.Models.MonthlyFeeVoucher", "monthlyFeeVoucher")
                        .WithMany()
                    ...
                    b.HasOne("GymMang.Models.GymTrainee", "gymTrainee")
                        .WithMany()
                        .HasForeignKey("gymTraineeTraineeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
